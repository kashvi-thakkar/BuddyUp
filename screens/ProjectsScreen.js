...
const styles = StyleSheet.create({
  ...
  createButton: { flexDirection: 'row', alignItems: 'center', margin: 16, backgroundColor: '#FFFFFF', padding: 12, borderRadius: 12, borderWidth: 1, borderColor: '#E5E7EB', justifyContent: 'center', gap: 8 },
  createButtonText: { fontSize: 16, fontWeight: '600', color: '#A30000' },
  listContainer: { padding: 16, paddingTop: 0 },
  projectCard: { backgroundColor: '#FFFFFF', borderRadius: 16, padding: 16, marginBottom: 16, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.05, shadowRadius: 8, elevation: 3 },
  ...
  skillBadge: { backgroundColor: '#FEF2F2', borderRadius: 8, paddingHorizontal: 10, paddingVertical: 4, marginRight: 8, marginBottom: 8 },
  skillText: { fontSize: 12, color: '#A30000', fontWeight: '500' },
  projectFooter: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingTop: 12, borderTopWidth: 1, borderTopColor: '#F3F4F6' },
  ...
  input: { borderWidth: 1, borderColor: '#E5E7EB', borderRadius: 12, padding: 12, fontSize: 16, color: '#111827', marginBottom: 16, backgroundColor: '#F9FAFB' },
